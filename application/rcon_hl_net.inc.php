...
class Rcon
{
  ...
  protected $connected;
  protected $server_ip;
  protected $server_password;
  protected $server_port;
  protected $socket;

  //public static $_RCON_CONNEXION;
  ...
  function __construct()
  {
    ...
    $this->connected = true;
    $this->server_ip = "";// "193.84.64.245"; 
    $this->server_port = "";// "27015"; 
    $this->server_password = "";// "";

    //$this->$_RCON_CONNEXION->$this->Connect($this->server_ip,$this->server_port,$this->server_password);
  }
  ...
  function Communicate($command)
  {
    ...
    if(substr($buffer, 0, 4) == "\xfe\xff\xff\xff")
    {
      ...
      $splitbuffer[$pacur]=substr($buffer,($pacur==($panum-1))?9:14);
      ...
      for ($i=1;$i<$panum;$i++)
      {
        ...
        {
          $splitbuffer[$pacur]=substr($buffer2,($pacur==($panum-1))?9:14);
        }
      }
